...
abdominal_agri = st.selectbox("Abdominal Ağrı", options=[("Hayır", 0), ("Evet", 1)])
genel_durum = st.selectbox("Genel Durum", options=[("Normal", 0), ("Hastalık", 1)])
idar_problemi = st.selectbox("İdrar Problemi", options=[("Hayır", 0), ("Evet", 1)])
inkordinasyon = st.selectbox("İnkordinasyon", options=[("Hayır", 0), ("Evet", 1)])
ishal = st.selectbox("İshal", options=[("Hayır", 0), ("Evet", 1)])
istahsizlik = st.selectbox("İştahsızlık", options=[("Hayır", 0), ("Evet", 1)])
kanama = st.selectbox("Kanama", options=[("Hayır", 0), ("Evet", 1)])
kusma = st.selectbox("Kusma", options=[("Hayır", 0), ("Evet", 1)])
oksuruk = st.selectbox("Öksürük", options=[("Hayır", 0), ("Evet", 1)])
